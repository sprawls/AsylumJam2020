...
Shader "TftS/Windows_00"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		[ASEBegin]_SphereMaskSize("Sphere Mask Size", Range( 0 , 10)) = 0
		_SphereMaskMin("Sphere Mask Min", Range( 0 , 1)) = 0
		[ASEEnd]_SphereMaskMax("Sphere Mask Max", Range( 0 , 1)) = 1
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 ShadowCoords = float4( 0, 0, 0, 0 );
					...
					#endif
				#endif
				float3 temp_cast_0 = (1.5).xxx;
				
				float3 appendResult17 = (float3(HeadandPlayerPosition.x , HeadandPlayerPosition.y , HeadandPlayerPosition.z));
				float smoothstepResult14 = smoothstep( _SphereMaskMin , _SphereMaskMax , ( distance( appendResult17 , WorldPosition ) * ( _SphereMaskSize * 0.1 ) ));
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = temp_cast_0;
				float Alpha = saturate( smoothstepResult14 );
...
Node;AmplifyShaderEditor.DistanceOpNode;7;-969.8361,181.1106;Inherit;False;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;12;-923.3084,392.4338;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0.1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;13;-760.1973,344.7762;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0.1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;11;-1062.309,577.4343;Inherit;False;Property;_SphereMaskMax;Sphere Mask Max;2;0;Create;True;0;0;0;False;0;False;1;0.863;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;10;-1062.309,494.4343;Inherit;False;Property;_SphereMaskMin;Sphere Mask Min;1;0;Create;True;0;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SmoothstepOpNode;14;-596.3077,363.4336;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;5;-417.6066,-105.0755;Inherit;False;Constant;_Float0;Float 0;0;0;Create;True;0;0;0;False;0;False;1.5;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;15;-425.181,361.7387;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
